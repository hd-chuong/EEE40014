...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myGpio2_v1_0_S00_AXI is
  ...
  signal ack_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute XILINX_LEGACY_PRIM of \ack_reg_reg[11]\ : label is "LD";
...
\ack_reg_reg[11]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\ack_reg_reg[11]__0\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => \ack_reg[15]_i_1_n_0\,
      D => s00_axi_wdata(11),
