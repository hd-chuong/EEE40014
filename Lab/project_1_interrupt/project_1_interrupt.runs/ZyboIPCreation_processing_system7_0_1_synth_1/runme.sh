...
HD_PWD='D:/Y4/hardsoft/Lab/project_1_interrupt/project_1_interrupt.runs/ZyboIPCreation_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboIPCreation_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboIPCreation_processing_system7_0_1.tcl
