...
HD_PWD='D:/Y4/hardsoft/Lab/project_1_interrupt/project_1_interrupt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboIPCreation_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZyboIPCreation_wrapper.tcl
