...
HD_PWD='D:/Y4/hardsoft/Lab/project_1_interrupt/project_1_interrupt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZyboIPCreation_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZyboIPCreation_wrapper.tcl -notrace
