...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_myGpio2_v1_0_S00_AXI is
  ...
  signal pdir_reg : STD_LOGIC_VECTOR ( 3 downto 0 );
...
\pdir_reg[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\pdor_reg[11]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7D7DC480"
    )
        port map (
...
\pdor_reg[15]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7D7DC480"
    )
        port map (
...
\pdor_reg[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7D7DC480"
    )
        port map (
...
\sync_buffer[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN ZyboIPCreation_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
