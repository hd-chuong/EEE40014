...
HD_PWD='D:/Y4/hardsoft/Lab/ip_repo/edit_MyGPIO_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyGPIO_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyGPIO_v1_0.tcl
