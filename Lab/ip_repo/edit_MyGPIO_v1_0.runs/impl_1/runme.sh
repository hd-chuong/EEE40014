...
HD_PWD='D:/Y4/hardsoft/Lab/ip_repo/edit_MyGPIO_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MyGPIO_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MyGPIO_v1_0.tcl -notrace
