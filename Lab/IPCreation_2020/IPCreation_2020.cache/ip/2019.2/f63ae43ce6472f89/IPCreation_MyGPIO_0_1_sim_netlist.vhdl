...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MyGPIO_v1_0_S00_AXI is
  ...
  signal \pdor_reg_reg_n_0_[0]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[10]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[11]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[12]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[13]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[14]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[15]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[16]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[17]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[18]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[19]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[1]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[20]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[21]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[22]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[23]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[24]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[25]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[26]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[27]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[28]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[29]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[2]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[30]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[31]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[3]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[4]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[5]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[6]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[7]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[8]\ : STD_LOGIC;
  signal \pdor_reg_reg_n_0_[9]\ : STD_LOGIC;
...
\GPIO_O[0]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \pdor_reg_reg_n_0_[0]\,
      O => GPIO_O(0)
    );
\GPIO_O[1]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \pdor_reg_reg_n_0_[1]\,
      O => GPIO_O(1)
    );
\GPIO_O[2]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \pdor_reg_reg_n_0_[2]\,
      O => GPIO_O(2)
    );
\GPIO_O[3]_INST_0\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \pdor_reg_reg_n_0_[3]\,
      O => GPIO_O(3)
    );
...
\pdor_reg[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 1e+08, PHASE 0.000, CLK_DOMAIN IPCreation_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
