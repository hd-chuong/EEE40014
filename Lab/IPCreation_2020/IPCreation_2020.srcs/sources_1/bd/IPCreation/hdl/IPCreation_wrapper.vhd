...
--Command     : generate_target IPCreation_wrapper.bd
--Design      : IPCreation_wrapper
...
end IPCreation_wrapper;

architecture STRUCTURE of IPCreation_wrapper is
  component IPCreation is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
...
IPCreation_i: component IPCreation
     port map (
