...
HD_PWD='D:/Y4/hardsoft/Lab/IPCreation_2020/IPCreation_2020.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IPCreation_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IPCreation_wrapper.tcl
