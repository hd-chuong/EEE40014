...
HD_PWD='D:/Y4/hardsoft/Lab/IPCreation_2020/IPCreation_2020.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IPCreation_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IPCreation_wrapper.tcl -notrace
